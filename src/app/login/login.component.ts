    ...
    if (this.loginForm1.valid) {
      this.apiService.loginUser(this.loginForm1.value).subscribe(
        (response: any) => {
          ...
          this.router.navigate(["/user-home"],{ queryParams: { u_name: this.loginForm1.value.em_id1 } });
    ...
    if (this.loginForm2.valid) {
      this.apiService.loginRecru(this.loginForm2.value).subscribe(
        (response: any) => {
          ...
          this.router.navigate(["/rec-home"],{ queryParams: { u_name: this.loginForm2.value.em_id2 } });
